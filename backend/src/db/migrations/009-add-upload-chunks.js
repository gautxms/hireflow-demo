export async function up(pool) {
  ...
  await pool.query(`
    CREATE INDEX IF NOT EXISTS idx_upload_chunks_user_status ON upload_chunks (user_id, status, created_at DESC);
    CREATE INDEX IF NOT EXISTS idx_upload_chunks_expires_at ON upload_chunks (expires_at);
  `)
}
