  ...
  return (
    <div className="ui-modal" role="dialog" aria-modal="true" aria-label="Block user">
      <div className="ui-card ui-card--card-spacing ui-modal__dialog w-full max-w-md">
        <h2 className="text-lg font-semibold text-admin-strong">Block user</h2>
        <p className="mt-1 text-sm text-admin-body">Add a reason for blocking {user.email}. This will be written to the audit trail.</p>
