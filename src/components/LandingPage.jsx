...
export default function LandingPage({ onStartDemo, onViewPricing, onViewDashboard, onViewAbout, onViewDemo, onViewContact, onViewHelp }) {
  ...
  return (
    <>
      ...
      {/* Footer */}
      <footer>
        <p>© 2026 Hireflow. All rights reserved. | <a href="/pricing" style={{ color: 'var(--accent)' }}>Pricing</a> | <a href="/privacy" style={{ color: 'var(--accent)' }}>Privacy</a> | <a href="/terms" style={{ color: 'var(--accent)' }}>Terms</a></p>
      </footer>
    </>
  )
}
