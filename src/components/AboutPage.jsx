...
export default function AboutPage({ onBack }) {
  ...
  return (
    <div className="public-page">
      ...
      <section className="public-section"><div className="about-story"><h2 className="public-section-title">Our Story</h2><p className="public-copy">Gautam spent 5 years as Head of Recruiting at Stripe, building their world-class talent team from scratch. He saw the pain firsthand: recruiters spend 40+ hours per week reading resumes, many of which could be screened by AI in seconds.</p><p className="public-copy">The tools available were either outdated (ATS from 2005) or overly complex (enterprise software that requires a PhD to operate). Gautam knew there had to be a better way, which is why we publish practical guides on <a href="/ai-resume-screening">AI resume screening</a> and <a href="/candidate-ranking-software">candidate ranking software</a>.</p><p className="public-copy">In early 2024, he brought together the best ML engineers from OpenAI, Google, and Databricks. Together, they built HireFlow: a modern, AI-powered recruiting tool that's simple, transparent, and actually works.</p><p className="public-copy">Today, 500+ companies use HireFlow to hire faster and smarter. We're just getting started. See <a href="/pricing">pricing</a> or <a href="/contact">contact our team</a> to plan your rollout.</p></div></section>
