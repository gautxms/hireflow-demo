    ...
    <div className="candidate-results-page">
      ...
      <div className="results-grid">
        {sortedCandidates.map((candidate, index) => {
          ...
          const hiddenCardTagCount = Math.max(0, cardTags.length - visibleCardTags.length)
            ...
            >
              ...
              {visibleCardTags.length > 0 && (
                <div className="rc-tags" aria-label={`${toDisplayText(candidate.name, 'Candidate')} tags`}>
                  ...
                  {hiddenCardTagCount > 0 && <span className="rc-tag-more" title={cardTags.slice(2).join(', ')} tabIndex={0}>+{hiddenCardTagCount}</span>}
                </div>
              )}
    ...
    >
      <div id="detail-drawer" className="detail-drawer">
        <div className="dd-header">
          ...
          <div className="dd-header-middle" aria-hidden={!hasSelectedJob ? 'true' : undefined}>
