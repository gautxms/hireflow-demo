...
- The new diagnostic reports which already-selected source won: `deterministic_jd_fit`, `ai_scoring_contract_v2`, `matchScore.score`, `candidate.score`, or `missing`. It is observational only.
