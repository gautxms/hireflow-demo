...
| BGX-003 | `/admin/billing` refund history list (`src/admin/pages/AdminPaymentsPage.jsx`) | Temporary use of slate utility classes (`text-slate-900`, `border-slate-100`) | Pending migration of refund history section to admin primitives + dark token utilities | Admin UI | 2026-04-19 | **2026-05-15** | Resolved 2026-04-20 (refund history styles migrated to admin tokenized border/text values) |
